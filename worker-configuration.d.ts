/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 749480f2a57641894c06d914a6ea6f2b)
// Runtime types generated with workerd@1.20260611.1 2026-05-15 nodejs_compat
interface __BaseEnv_Env {
	BROWSER: BrowserRun;
	AI: Ai;
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").WebToolsMCP>;
	CLOAK: DurableObjectNamespace<import("./src/index").CloakBrowser>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WebToolsMCP" | "CloakBrowser";
	}
